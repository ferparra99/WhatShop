...
public class SellerServiceImpl implements SellerService {
    ...
    public SellerProfileDTO getMyProfile(User user) {
    ...
    @Transactional
    public SellerProfileDTO updateMyProfile(User user, UpdateSellerRequest request) {
        var seller = sellerRepository.findByUserId(user.getId())
                .orElseThrow(() -> new ResourceNotFoundException("Perfil de vendedor no encontrado"));
    ...
    @Transactional
    public SellerProfileDTO createSellerProfile(User user, String storeName,
