package com.tuapp.marketplace.products.controller;
...
import com.tuapp.marketplace.products.service.ProductService;
...
public class ProductController implements ProductAPI {
     ...
     * @throws com.tuapp.marketplace.shared.exception.ResourceNotFoundException si no existe
     */
    @GetMapping("/{id}")
    @Override
